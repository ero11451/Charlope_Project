  ...
  return (
      ...
      <section className='blog'>
                ...
                <div className='blog__single van-tilt'>
                  <div className='blog__single-thumb'>
                    <Link href='/blog-details'>
                      <Image width={500} height={100} src='/assets/images/blog/one.png' alt='Image_inner' />
                    </Link>
                    <div className='tag'>
                      <Link href='/blog-list'>
            ...
            <div className='col-12 col-lg-6 col-xl-4'>
              ...
              >
                <div className='blog__single van-tilt'>
                  <div className='blog__single-thumb'>
                    <Link href='/blog-details'>
                      <Image width={500} height={100} src='/assets/images/blog/two.png' alt='Image_inner' />
                    </Link>
                    <div className='tag'>
                      <Link href='/blog-list'>
                        <i className='fa-solid fa-tags' />
        ...
        <div className='blog-bg'>
          <Image width={500} height={100} src='/assets/images/blog/blog-bg.png' alt='Image_inner' />
        </div>
        <div className='spade'>
          <Image width={500} height={100}
